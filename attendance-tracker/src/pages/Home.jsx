...
const AeroWhiteDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      const [attRes, taskRes, projRes, subRes, semRes] = await Promise.all([
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-14 gap-4 md:gap-6 lg:gap-8">
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-9 bg-white/80 backdrop-blur-2xl border border-white rounded-[1.3rem] md:rounded-[4rem] p-4 md:p-10 lg:p-14 shadow-2xl shadow-slate-200/60 relative overflow-hidden group">
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex flex-col xl:flex-col justify-between items-start gap-8 mb-8 md:mb-12">
                      ...
                      <div className="w-full xl:w-full space-y-3 md:space-y-4">
                ...
                <div className="col-span-1 lg:col-span-14 bg-[#0f172a] rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.6)] border border-white/5">
                  {/* Header */}
